...
import { ArrowRight, Heart, Activity, Pill } from "lucide-react";
...
const PredictionTool = ({ title, description, icon, link }: PredictionToolProps) => {
  return (
    <motion.div
      className="p-6 rounded-lg border border-gray-200 dark:border-white/10 bg-white dark:bg-[#0f1123] flex flex-col shadow-sm"
    ...
    >
      ...
      >
        <Link 
          href={link} 
          className="flex items-center text-sm md:text-base font-medium text-blue-600 dark:text-blue-400"
        >
...
export default function PredictionTools() {
  ...
  return (
    <section className="w-full py-16 px-4 md:px-8 bg-gray-50 dark:bg-[#0a0c16] text-gray-900 dark:text-white">
